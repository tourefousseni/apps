...
def parse_gravity_row(data_rows, parser, data_row):
    ...
    if row_dict['transaction type'] == "deposit":
        if row_dict['from accounts'] == SYSTEM_ACCOUNT:
        ...
        if row_dict['to accounts'] == SYSTEM_ACCOUNT:
            ...
            return
    elif row_dict['transaction type'] == "trade" and row_dict['from accounts'] == SYSTEM_ACCOUNT:
        ...
        if sell_quantity is None:
            return
    elif row_dict['transaction type'] == "trade" and row_dict['to accounts'] == SYSTEM_ACCOUNT:
        t_type = TransactionOutRecord.TYPE_TRADE
        sell_quantity = row_dict['amount']
        sell_asset = row_dict['currency']
...
DataParser(DataParser.TYPE_EXCHANGE,
           "Gravity (Bitstocks)",
           ['transaction id', 'from accounts', 'to accounts', 'from accounts type', 'to accounts type',
...
DataParser(DataParser.TYPE_EXCHANGE,
           "Gravity (Bitstocks)",
           ['transaction id', 'from accounts', 'to accounts', 'date utc', 'transaction type',
